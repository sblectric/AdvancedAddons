...
import com.advancedaddons.misc.TrackingDispenserBehavior.BehaviorTrackingFireballDispense;
import com.advancedaddons.misc.TrackingDispenserBehavior.BehaviorTrackingProjectileDispense;
import com.advancedaddons.registry.IRegistryBlock;

/** The tracking dispenser */
public class BlockTrackingDispenser extends BlockDispenser implements IRegistryBlock {
        ...
        if (tile != null) {
            ...
            if (i < 0) {
                ...
                if (defaultbehavior != IBehaviorDispenseItem.DEFAULT_BEHAVIOR) {
                    ...
                    tile.setInventorySlotContents(i, itemstack1.stackSize <= 0 ? null : itemstack1);
                }
            }
        }
    }
