...
import com.advancedaddons.items.ItemArmorNether;
import com.advancedaddons.items.ItemArmorObsidian;
...
public class ArmorHandler {
	...
	public void onLivingHurt(LivingHurtEvent e) {
		if(!e.getEntityLiving().worldObj.isRemote && e.getSource() != null) {
			// handle armor stuff
	...
	public static int getWearingSetCount(EntityLivingBase entity, Class<? extends ItemArmor> armorClass) {
		...
		boolean helm = HEAD != null && armorClass.isInstance(HEAD.getItem());
		boolean chest = CHEST != null && armorClass.isInstance(CHEST.getItem());
		boolean legs = LEGS != null && armorClass.isInstance(LEGS.getItem());
		boolean boots = FEET != null && armorClass.isInstance(FEET.getItem());
